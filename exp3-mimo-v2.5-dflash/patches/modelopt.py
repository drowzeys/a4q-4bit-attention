...
class ModelOptMixedPrecisionConfig(ModelOptQuantConfigBase):
    ...
    def __init__(
        ...
        # EXP3 PATCH (recreated eugr fix-modelopt-mixed-mxfp8 for 0.24):
        # MIXED_PRECISION checkpoints (e.g. lukealonso/MiMo-V2.5-NVFP4) mark
        # attention qkv_proj layers as MXFP8, which the stock dispatch left
        # unquantized (bf16 params) so the fp8 checkpoint tensors had no home.
        self.mxfp8_config = ModelOptMxFp8Config(
    ...
    def get_quant_method(
        ...
        if isinstance(layer, (LinearBase, ParallelLMHead)):
            ...
            # EXP3 PATCH: dispatch MXFP8 linear layers (MiMo attn qkv_proj)
            if quant_algo == "MXFP8":
